...
begin
	...
	if Interrupteur(7)='1' then
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					& '0'				                    -- Start Bit
					& "00000001"		                    -- Champ Adresse 1
					& '0'				                    -- Start Bit
					& "01110110"		                    -- Champ Commande vitesse 10
					& '0'				                    -- Start Bit
					& ("00000001" xor "01110110" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	...
	-- Interrupteur 6 Activé
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					...
					& "00000001"		                    -- Champ Adresse 1
					& '0'				                    -- Start Bit
					& "01010110"		                    -- Champ Commande vitesse 10
					& '0'				                    -- Start Bit
					& ("00000001" xor "01010110" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	...
	-- Interrupteur 5 Activé
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					...
					& '0'				                    -- Start Bit
					& ("00000001" xor "10010000" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	...
	-- Interrupteur 4 Activé
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					...
					& '0'				                    -- Start Bit
					& ("00000001" xor "10000000" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	...
	-- Interrupteur 3 Activé
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					...
					& '0'				                    -- Start Bit
					& ("00000001" xor "10100100" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	-- Interrupteur 2 Activé
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					...
					& '0'				                    -- Start Bit
					& ("00000001" xor "10100000" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	...
	-- Interrupteur 1 Activé
		...
		Trame_DCC <= "11111111111111"				                        -- Préambule
					...
					& "00000001"		                                    -- Champ Adresse 1
					& '0'				                                    -- Start Bit
					& "11011110"		                                    -- Champ Commande 1 octet
					& '0'                                                   -- Start Bit
					& "00000001"                                            -- Champ Commande 2 octet
					& '0'				                                    -- Start Bit
					& ("00000001" xor "11011110" xor "00000001" )			-- Champ Contrôle
					& '1'	;			                                    -- Stop Bit
	...
	-- Interrupteur 0 Activé
		...
		Trame_DCC <= "11111111111111"				                        -- Préambule
					...
					& "11011110"		                                    -- Champ Commande 1 octet 
					& '0'                                                   -- Start Bit
					& "00000000"                                            -- Champ Commande 2 octet
					& '0'				                                    -- Start Bit
					& ("00000001" xor "11011110" xor "00000000" )			-- Champ Contrôle
					& '1'	;			                                    -- Stop Bit
	...
	-- Aucun Interrupteur Activé
		...
		Trame_DCC <= "11111111111111111111111"				-- Préambule
					...
					& "00000001"		                    -- Champ Adresse 1
					& '0'				                    -- Start Bit
					& "01100000"		                    -- Champ Commande vitesse 10
					& '0'				                    -- Start Bit
					& ("00000001" xor "01100000" )			-- Champ Contrôle
					& '1'	;			                    -- Stop Bit
	end if;
end process;
